...
public class InvoiceAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Invoice Manager");
 ...
 if (evt.getClickCount() == 2) { // Kiểm tra số lần nhấp chuột là 2
   ...
   this.dispose();        // TODO add your handling code here:
    ...
    try {
        ...
        String selectQuery = "SELECT i.*, d.Name AS Doctor_name, p.Patient_name AS Patient_name " +
                             "FROM Invoices i " +
                             "JOIN DoctorManager d ON i.Doctor_id = d.Doctor_id " +
        ...
        document.addAuthor("Clinic Management System");

        if (rs.next()) {
            // Add patient information instead of invoice number
            document.add(new Paragraph("Patient: " + rs.getString("Patient_name"), FontFactory.getFont(FontFactory.HELVETICA_BOLD, 16)));
            document.add(new Paragraph(" "));
            document.add(new Paragraph("--------------------------------------"));
